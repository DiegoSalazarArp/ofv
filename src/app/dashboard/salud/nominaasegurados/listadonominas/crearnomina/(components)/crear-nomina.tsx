...
export default function CrearNomina() {
  ...
  const [formData, setFormData] = useState({
    ...
    nombreTitular: "",
    grupoTitular: "",
    fechaIncorporacionTitular: "",
    inicioVigenciaTitular: "",
    tipoAseguradoTitular: "",
    terminoVigenciaTitular: ""
  })
  ...
  const handleCorredorSubmit = (data: { broker: string, policy: string }) => {
    ...
    setFormData({
      ...
      grupoTitular: "Grupo A",
      fechaIncorporacionTitular: "2024-01-01",
      inicioVigenciaTitular: "2024-01-01",
      tipoAseguradoTitular: "Normal",
      terminoVigenciaTitular: "2024-12-31"
    })
  }

  const handleSearch = () => {
    // Simular búsqueda con el RUT
    if (formData.rutTitular) {
      setFormData({
        ...formData,
        nombreTitular: "Juan Pérez",
        grupoTitular: "Grupo A",
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-2">
                        <Input 
                          ...
                          onChange={(e) => setFormData({...formData, rutTitular: e.target.value})}
                        />
                        <Button 
                          size="icon" 
                          variant="secondary" 
                  ...
                  <div>
                    ...
                    <Input 
                      id="grupoTitular" 
                      name="grupoTitular"
                      value={formData.grupoTitular}
                      onChange={(e) => setFormData({...formData, grupoTitular: e.target.value})}
                    />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input 
                      ...
                      type="date"
                      value={formData.fechaIncorporacionTitular}
                      onChange={(e) => setFormData({...formData, fechaIncorporacionTitular: e.target.value})}
                    />
                  </div>
                  <div>
                    ...
                    <Input 
                      ...
                      type="date"
                      value={formData.inicioVigenciaTitular}
                      onChange={(e) => setFormData({...formData, inicioVigenciaTitular: e.target.value})}
                    />
                  </div>
                  <div>
                    ...
                    <Input 
                      ...
                      value={formData.tipoAseguradoTitular}
                      onChange={(e) => setFormData({...formData, tipoAseguradoTitular: e.target.value})}
                    />
                  </div>
                  <div>
                    ...
                    <Input 
                      ...
                      type="date"
                      value={formData.terminoVigenciaTitular}
                      onChange={(e) => setFormData({...formData, terminoVigenciaTitular: e.target.value})}
                    />
                  </div>
                </div>
              </div>
