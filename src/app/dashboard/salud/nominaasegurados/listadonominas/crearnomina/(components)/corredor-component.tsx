...
interface CorredorComponentProps {
  onSubmit: (data: { broker: string; policy: string }) => void;
}

export default function CorredorComponent({ onSubmit }: CorredorComponentProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
      <div className=''>
        ...
        <Label htmlFor="broker">Corredor</Label>
